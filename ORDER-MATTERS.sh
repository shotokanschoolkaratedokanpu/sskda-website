#!/bin/bash
echo "═══════════════════════════════════════════════════════════════"
echo "🔑 THE ORDER MATTERS: Middleware placement in Express"
echo "═══════════════════════════════════════════════════════════════"
echo ""

cd /home/ailove/Downloads/SSKDA_Website

# Fix server.js - static middleware must come FIRST
...
echo "✓ Reordered server.js - static middleware FIRST"
git add server.js
git commit -m "CRITICAL: Static middleware MUST be before express.json()"
